...
import arthur.francisco.gabi.mary.maissus.adapters.VacinasAdapter;
...
public class VacinasFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<Vacina> vacinas = homeActivityViewModel.getVacinas();

        VacinasAdapter vacinasAdapter = new VacinasAdapter((HomeActivity) getActivity(), vacinas);

        RecyclerView rvVacinas = view.findViewById(R.id.rvVacinas);
        rvVacinas.setAdapter(vacinasAdapter);

        rvVacinas.setLayoutManager(new LinearLayoutManager(getContext()));
    }
}